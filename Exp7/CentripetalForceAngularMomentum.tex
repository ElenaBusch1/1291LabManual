...
\begin{figure}[!h]
	\begin{center}
	\includegraphics[width=0.8\textwidth]{./Exp7/pic/appbalance2.png}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
	\includegraphics[width=0.5\textwidth]{./Exp7/pic/screenshot1.png}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
	\includegraphics[width=0.7\textwidth]{./Exp7/pic/apparatus.png}
	\end{center}
